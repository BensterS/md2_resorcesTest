...
//初始化相关路径
NSString* ccbPath = @"/Users/Benster/Desktop/Works/乐多/仙魔录花千骨/md2_res_src2/ccb/Resources";       //ccb文件路径
NSString* ccbPath1 = @"/Users/Benster/Desktop/Works/乐多/仙魔录花千骨/md2_res_src2/ccb/Resources1";     //ccb文件路径
NSString* resSourcePath = @"/Users/Benster/Desktop/Works/乐多/仙魔录花千骨/md2_res_src2/tps/strpng2/";  //资源源目录
NSString* resDescPath = @"/Users/Benster/Desktop/Works/乐多/仙魔录花千骨/md2_res_src2/tps/srcpng/";     //资源目标目录
NSString* sharePath = @"/Users/Benster/Desktop/Works/乐多/仙魔录花千骨/md2_res_src2/tps/srcpng/share/"; //公共资源目录
NSString* logPath = @"/Users/Benster/Desktop/CCBTest/CCBTest/ccb/";                                  //输出文件目录
NSString* ccbiLogPath = @"/Users/Benster/Desktop/CCBTest/CCBTest/ccbi/";
...
void ccbPlistReplace(NSString* fileURL, NSString* fileName)
{
    ...
    for (NSUInteger i = 0; i < [arr count]; i ++) {
        ...
        if (location != 9223372036854775807 && length != 9223372036854775807 && length - location - 8 > 0) {
            ...
            if (location2 != 9223372036854775807) {
                [fileInfo appendString:[NSString stringWithFormat:@"%@a/", [arr[i] substringToIndex:location + 20]]];
    ...
    [fileInfo writeToFile:[NSString stringWithFormat:@"%@/%@.ccb", ccbPath1, fileName] atomically:NO encoding:NSUTF8StringEncoding error:nil];
}
...
{
    @autoreleasepool {
        ///Users/Benster/Desktop/CCBTest/md2_res_src
        ///Users/Benster/Desktop/CCBTest/md2_res_src/ccbi960/Resources
